...
namespace Hanafalah\ModuleEvent\Facades;
 ...
 */
class ModuleEvent extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleEvent\Contracts\ModuleEvent::class;
  }
}
